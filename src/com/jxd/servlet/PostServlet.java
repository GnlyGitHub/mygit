...
public class PostServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String fromer = (String)httpSession.getAttribute("uname");

        //创建Message对象
        Message message = new Message(uname,title,content,addressee,fromer);
        IMessageService messageService = new MessageServiceImpl();

        request.setAttribute("postMsg",messageService.addMsg(message));
