    ...
    <div  style="width: 805px">
        ...
        <div align="right">
            <p>当前用户:<span style="color: #1E9FFF">${sessionScope.uname}</span>&nbsp;&nbsp;
                ...
                <a href="listPost.jsp">已发送</a>&nbsp;&nbsp;
                <a href="recycle.jsp">回收站</a>&nbsp;&nbsp;
                <a href="ExitServlet">退出</a>
            </p>
        </div>

        <table class="layui-table" lay-data="{width: 805, height:330, url:'/GetMsgByAddresseeServlet', page:false, id:'idTest'}" lay-filter="demo">
            <thead>
            <tr>
                <%--<th lay-data="{type:'checkbox', fixed: 'left'}"></th>--%>
                <th lay-data="{field:'msgno', width:10, display:none}">编号</th>
                <th lay-data="{field:'read', width:60, templet: '#titleTpl'}">状态</th>
                ...
                <th lay-data="{field:'fromer', width:80}">来自</th>
        ...
        table.on('tool(demo)', function(obj){
            ...
            if(obj.event === 'detail'){
                ...
                layer.confirm('确定删除吗', function(index){
                    layer.close(index);
                    location.href = "DelServlet?msgno=" + data.msgno;
                });
            } else if(obj.event === 'reply'){
                location.href = "reply.jsp?addressee=" + data.fromer;
            }
        });
